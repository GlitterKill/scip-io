...
fn main() {
    ...
    let result = match cli_args.command {
        ...
        Some(cli::Command::Install(args)) => rt.block_on(cli::install::run(args)),
        Some(cli::Command::Uninstall(args)) => rt.block_on(cli::uninstall::run(args)),
        Some(cli::Command::Update(args)) => rt.block_on(cli::update::run(args)),
